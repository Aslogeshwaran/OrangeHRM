...
public class DriverUtils extends BaseClass{
	...
	public static void captureScreenShot(String fileName)
	{
		...
		String filePath=Constants.screenShotPath+"\\"+fileName+System.currentTimeMillis()+".png";
		
		File screenShotTo=new File(filePath);
		try {
	...
	public static String captureScreenShotWithBASE64()
	{
		TakesScreenshot screen=(TakesScreenshot)driver;
